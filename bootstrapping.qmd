...
coord_flip() + theme_bw(base_size = 20) + labs(y = "Difference in Ridership from Other Lines", x = "Rail Line", color = "Rail Line", title = "OMNY Use Proportion Differences by Rail Line")
